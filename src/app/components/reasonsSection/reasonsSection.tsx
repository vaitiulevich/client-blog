...
export const ReasonsSection = () => {
  ...
  return (
    <section className="wrapper-component relative flex items-end text-dark mb-24">
      <div className="relative overflow-hidden min-h-[35rem] w-[70%] flex items-end px-16">
        <Image
          src={banner}
          alt="about banner"
          fill
      ...
      <div className="absolute h-[80%] bg-lightBG z-3 w-[40%] right-[7rem] p-14 flex flex-col justify-between items-start gap-4">
