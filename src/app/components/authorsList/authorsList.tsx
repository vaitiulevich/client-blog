  ...
  return (
    <div className="py-8 wrapper-component">
      ...
      <div className="grid grid-cols-4 gap-4 max-md:grid-cols-2">
        {data.map((item) => (
          <div
            className="flex flex-col items-center justify-start gap-1 bg-gray-100 px-4 py-8 transition-transform duration-300 ease-in-out hover:bg-yellowOpasity hover:shadow-lg hover:scale-105"
            key={item.id}
          >
            <Link
              href={`/author/${item.id}`}
            ...
            <p className="m-0 text-xs mb-4 text-grey transition-colors duration-300 ease-in-out hover:text-yellow">
